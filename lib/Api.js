...
class Api {
   ...
   * @returns {Promise<any>}
   */
  getPosterProfit({ begin_period, end_period, poster }) {
    return this.proxy('db_api', 'get_post_profits_detail', [
      begin_period,
      end_period,
      platform,
   ...
   * @returns {Promise<any>}
   */
  getPlatformProfit({ begin_period, end_period, platform }) {
   ...
   * @returns {Promise<U>|Promise.<T>|*|Promise} resolve(list 文章列表), reject(e 异常信息)
   */
  getAdPurchaserOrders({ purchaser, lower_bound_advertising_order, limit }) {
